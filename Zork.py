...
while True:
	...
	while loop == 4:
		if loop == 4:
			...
			hint("can take or open the mailbox , try moving in different directions , actions on the door or just look at the house!")
	...
	while loop == 8:
		if loop == 8:
			...
			hint("try moving in different directions")
	...
	while loop == 9:
		if loop == 9:
			...
			hint("descend grating or go south?")
	...
	while loop == 10:
		if loop == 10:
			...
			hint("do something with the skeleton or scale the staircase?")
	...
	while loop == 11:
		if loop == 11:
			...
			hint("The trunk is there , what more hint do you want?")
